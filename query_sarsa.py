...
def sarsa_show_road(j,w,l):
    ...
    folium.Marker(location[len(w) - 1],
                  ...
                  icon=folium.Icon( color="red")).add_to(m)
    m.save(os.path.join( r'D:\学习\毕业设计\项目\templates','sarsa_geo_road.html'))  #将结果以HTML形式保存到桌面上
